...
SECRET_KEY = 'django-insecure-b07p%*@y)q#jg$g06n7hs#fr&a+51!+5u!np@a*(ixw=q&v3zu'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.TokenAuthentication',  # Для старих токенів
...
AUTHENTICATION_BACKENDS = [
    #'users.authentication.EmailBackend',  # Ваш кастомний бекенд
